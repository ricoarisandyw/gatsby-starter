...
import { ChevronDownIcon, CubeIcon, GlobeAltIcon } from '@heroicons/react/solid'
...
const solutions = [
  ...
  { name: 'Mixed Reality', description: "Your customers' data will be safe and secure.", href: '#', icon: CubeTransparentIcon },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-10 text-white">
            <a href="#" className="text-base font-medium text-white hover:text-purple-300">
              HOME
            </a>
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      'group rounded-md inline-flex items-center text-base font-medium hover:text-purple-300 focus:outline-none'
                    )}
                  >
                    <span className="text-white hover:text-purple-300">SERVICES</span>
                    <ChevronDownIcon
                      className={classNames(
