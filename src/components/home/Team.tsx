        ...
        <div className="p-6">
            <div className="p-6 bg-team rounded-xl text-center">
                <div>
                    ...
                    <span className="text-white">Our team have real profesionnal experencie</span>
                </div>
                <div className="grid grid-col-1 lg:grid-cols-3">
                    <div className="text-center text-white p-6">
                        ...
                        <span>Master Student at PENS, XR Developer at Universitas Nahdlatul Ulama Surabaya</span><br/>
                    </div>
                    <div className="text-center text-white p-6">
                        ...
                        <span className="">Abdul Aziz</span><br/>
                        <span>MBA Candidate at Nexford University, US. Cloud Consultant at Cloud Comrade Pte. Ltd</span><br/>
                    </div>
                    <div className="text-center text-white p-6">
                        ...
                        <span>Master Student at PENS,Software Engineer at Ruangguru</span><br/>
                    </div>
                </div>
